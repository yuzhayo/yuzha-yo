...
export async function mountThreeLayers(scene, entries) {
    const meshes = [];
    ...
    for (const entry of entries) {
        ...
        const planeGeometry = new THREE.PlaneGeometry(texture.image.width * scale.x, texture.image.height * scale.y);
