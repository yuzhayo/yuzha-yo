        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <p className="text-sm text-cream text-opacity-80">
              Restoran kelas atas dengan cita rasa nusantara. Menyajikan hidangan berkualitas dengan
              suasana yang nyaman.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="text-sm text-cream text-opacity-80 space-y-2">
              ...
              <p>
                ...
                <a href={`tel:${warungInfo.phone}`} className="hover:text-gold transition-colors">
                  {warungInfo.phone}
                </a>
              </p>
              <p>
