...
export type Counter2FloatingButtonProps = {
  size?: number;
  screenPosition?: { x: number; y: number };
  onActivate?: () => void;
};

export default function Counter2FloatingButton({
  size = 128,
  screenPosition = { x: 24, y: 24 },
  onActivate,
}: Counter2FloatingButtonProps) {
    ...
    >
      ...
      >
        ...
        <button
          ...
          onKeyUp={handleKeyUp}
          aria-label="Counter2 Floating Button"
          style={{
            width: size,
            height: size,
            maxWidth: "90vw",
