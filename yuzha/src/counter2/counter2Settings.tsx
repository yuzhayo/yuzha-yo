...
export default function Counter2Settings({ onClose }: Counter2SettingsProps) {
      ...
      <div className="relative w-[90%] max-w-md bg-slate-900/95 border border-slate-700/50 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="px-4 py-3 bg-slate-800/30 border-t border-slate-700/50 flex justify-end gap-2">
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-2 text-sm font-medium text-slate-300 bg-slate-700/50 hover:bg-slate-600/50 rounded-lg transition-colors"
          >
            Cancel
          </button>
          <button
